...
* **URL**: `ws://<your-server-ip>:8080/v1/stream`
...
```
ws://127.0.0.1:8080/v1/stream?robotId=<机器人ID>&conversationId=<会话ID>
```
...
```
ws://127.0.0.1:8080/v1/stream?robotId=robot_123&conversationId=conv_456
```
...
```
ws://127.0.0.1:8080/v1/stream?robotId=robot_123&token=user_token_abc123
```
...
wx.connectSocket({
  url: `ws://127.0.0.1:8080/v1/stream?robotId=${robotId}&conversationId=${conversationId}`,
  header: {
